      ...
      <div className="container">
        <div className="cosmetics__content">
          <div className="cosmetics__info">
            <h2 className="cosmetics__title" data-ru={title} data-en="Cosmetics Shop">
              {title}
            </h2>
            <p
